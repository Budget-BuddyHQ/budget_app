...
class _LessonScreenState extends State<LessonScreen>
  ...
  void initState() {
    ...
    _bgController = AnimationController(
      vsync: this,
      duration: const Duration(seconds: 20), // Smoother, less active animation
    )..repeat(reverse: true);
  ...
  void _handleButtonPressed(BuildContext context) {
    if (_isCompleted) {
      ...
      // Update UI state to change button text
      setState(() {
        _isCompleted = true;
      });
      ...
      body: AnimatedBuilder(
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: const [
                    Color(0xFF1B3329), // Darker Forest
                    Color(0xFF2E4A3D), // Deep Forest
                    Color(0xFF3E5F4F), // Muted Green
                    Color(0xFF2E4A3D), // Deep Forest
                  ],
                ),
              ),
        ...
        child: Stack(
          children: [
            ...
            Positioned.fill(
              child: SafeArea(
                bottom: false, // Allow content to scroll behind the bottom bar
